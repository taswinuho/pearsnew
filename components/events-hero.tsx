  ...
  return (
    <section className="relative min-h-[70vh] bg-[#0a1628] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#ff5722]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-[#ff5722]/15 rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-32 text-center">
        ...
        >
          ...
          <span className="text-[#ff5722] text-sm font-bold uppercase tracking-wider">2025 Season</span>
        </motion.div>
        ...
        >
          Racing <span className="text-[#ff5722] font-brier">Events</span>
        </motion.h1>
        ...
        >
          Discover exciting pushbike racing events for young riders aged 2-6 years. Join the PEARS community and watch
          your little champion shine!
        </motion.p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">20+ Venues</span>
          </div>
          <div className="flex items-center gap-2">
            <Users className="w-5 h-5 text-[#ff5722]" />
            <span className="font-medium">500+ Riders</span>
          </div>
          <div className="flex items-center gap-2">
            <Calendar className="w-5 h-5 text-[#ff5722]" />
            <span className="font-medium">Year-Round Racing</span>
          </div>
        </motion.div>
      </div>
    </section>

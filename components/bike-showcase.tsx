...
export default function BikeShowcase() {
  return (
    <section className="relative bg-[#0a1628] px-6 md:px-12 overflow-hidden pb-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-screen">
          <div className="flex flex-col justify-center items-start lg:items-end lg:pr-12 order-2 lg:order-1">
            <div className="relative">
              ...
              <div
                className="absolute -left-16 -top-20 lg:-left-24 lg:-top-32 text-[#ff5722] opacity-30 text-[200px] lg:text-[280px] leading-none pointer-events-none select-none simteste"
              ...
              <blockquote className="relative z-10 max-w-xl">
                <p className="text-4xl md:text-5xl lg:text-6xl font-black uppercase text-white leading-[1.1] tracking-tight mb-8">
                  <span className="block mb-2">EVERY RACE</span>
                  <span className="block mb-2">IS A CHANCE TO</span>
                  <span className="block text-[#ff5722] font-brier normal-case text-5xl md:text-6xl -ml-1 lg:text-8xl">
                    GROW
                  </span>
                  <span className="block mt-2">LEARN AND</span>
              ...
              {/* Author attribution */}
              <div className="mt-4">
                <p className="text-base font-medium font-mono md:text-lg text-[#ff5722]">- PEARS Philosophy</p>
              </div>
            </div>
          </div>
